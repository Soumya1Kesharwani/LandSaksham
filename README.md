...
12. **AI Government Officer Copilot**: RAG-grounded conversational assistant citing exact project files and answering in English or Hindi.
...
14. **Multilingual Support (i18n)**: Instant switching between **English and हिन्दी (Hindi)** with scalable JSON dictionaries.
...
- **Backend**: Python 3.14, FastAPI, Pydantic v2, Uvicorn, Scikit-Learn/XGBoost formulation, SHAP explainability.
...
8. **Language Switch**:
   - Toggle **हिन्दी** in header to verify full translation of all 15 modules.
9. **Report Generation**:
...
- [Government Data & Live API Integration Guide](file:///Users/apple/Downloads/SIH-main/SIH%20project%202/docs/GOVERNMENT_DATA_INTEGRATION.md)
- [Multilingual Localization & Adding New Indian Languages](file:///Users/apple/Downloads/SIH-main/SIH%20project%202/docs/I18N_LOCALIZATION_GUIDE.md)
